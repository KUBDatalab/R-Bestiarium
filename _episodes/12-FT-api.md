...
# Instead, please edit 12-FT-api.md in _episodes_rmd/
...
~~~
[1] "https://oda.ft.dk/api/Sag?$filter=(typeid%20eq%2010)"
~~~
{: .output}
...
'https://oda.ft.dk/api/AktørAktør': HTTP status was '404 Not Found'
~~~
{: .warning}
...
~~~
Error in open.connection(con, "rb"): cannot open the connection to 'https://oda.ft.dk/api/AktørAktør'
~~~
{: .error}
